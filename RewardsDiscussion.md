...
the employee’s core priorities. Each represents an impact to the team, business, or customer - and whether positive or
negative, each can help managers coach an employee for greater impact and provide context for reward recommendations.<br>
<br>
      
Activity | ➔ | Impact
-- | -- | --
Met with 6 customers | ➔ |  Customer meetings helped close $X in new revenue or upsell.
Delivered 2 Conference Talks | ➔ | Conference Talks received X satisfaction rating and increased positive impression of GitHub, resulting in positive story from influencer.
Shipped 3 features | ➔ | Feature X contributed to MEU increase by...<br> Feature Y increased enterprise adoption by...<br> Feature Z saved time, higher quality
Root caused 2 outages | ➔ | RCA resulted in 2 learnings, changed process, prevented future issues
Joined a Community of Belonging (CoB) | ➔ | After joining a CoB, attended the Ability Summit. Organized a session for my team to share some of the learnings/best practices and it was well received. Have seen team members become more inclusive both in-person and in product design. Project ‘ADAW’ is a brainchild of this session
Implemented new process | ➔ | New process saved 6 steps, removed 2 approvals and estimated time savings of 2 days.
...
different employees, as well as different opportunities to have impact. Employees can work with their manager using 1:1’s and
...
circumstances may change. As such, expectations and an employee’s opportunity for impact can also change each year and
sometimes during the year. An employee or their manager might recommend making a change to the employee’s priorities
and related expectations. Any change should be discussed and agreed upon in an employee’s 1:1’s and Reflections through-out
the year.<br>
...
opportunity for impact is lower, then their resulting impact may also be lower. It’s important that you **remember to consider
your employee’s contributions for the full fiscal year and ensure your rewards recommendation represents impact
...
- [ ]  Were they able to contribute to others’ success with the shift in priorities?
...
- [ ] Business Need: where has your team’s scope or work expanded?  Which roles will be taking on this expanded scope?
...
- [ ] Be ready to discuss each team member’s impact.
...
*Communicate*
- [ ] If a manager didn’t attend the impact discussion, their manager is expected to: 
- [ ] Share themes and examples  of  higher/target/lower impact
- [ ] Ensure alignment to benchmarks
- [ ] If edits were made, to a manager’s recommendation be sure to communicate the change and rationale
...
**Potential Talking Points:**
* “We had to prioritize to respond to what’s happening globally, and that’s always a challenge. For work that was delayed/cancelled, know that I considered the contributions you made prior to the delay/cancellation since you had impact throughout the project – milestones, partnerships, innovation, etc.”<br>
* “Know that I determined your impact relative to the opportunity that you had, including impact you had during the project that was delayed/cancelled and any new work you took on when priorities changed.”<br>
* “Let’s review your core priorities going forward so they are aligned to our highest priorities for the business where possible, and so you’re set up for success.”
...
* Express care, empathy, and gratitude when acknowledging any significant changes to an employee’s situation.<br>


**Potential Talking Points:**
* “I am grateful that you took time away to prioritize your safety/well-being.”<br>
